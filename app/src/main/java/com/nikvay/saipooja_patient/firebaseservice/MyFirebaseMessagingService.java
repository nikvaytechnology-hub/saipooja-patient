package com.nikvay.saipooja_patient.firebaseservice;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService
{
    ...
    public ArrayList<PatientModel> patientModelArrayList;
...
//        EventBus.getDefault().post(new HomeActivity.MessageEvent(title,description));
    ...
    private void sendNotification(String title, String description, String redirectId, String date, String time) {
        ...
        patientModelArrayList= SharedUtils.getUserDetails(MyFirebaseMessagingService.this);
        patientName = patientModelArrayList.get(0).getName();
...
//        PendingIntent  pendingIntent=PendingIntent.getActivity(this,0,intent,PendingIntent.FLAG_ONE_SHOT);
        ...
        notificationSmall.setTextViewText(R.id.tv_notification_name_small, "Hey  "+ patientName +" new notification received.");
        notificationSmall.setTextViewText(R.id.tv_notification_title_small, description);
        notificationSmall.setTextViewText(R.id.tv_notification_desc_small, patientName);
//
        notificationBig.setTextViewText(R.id.tv_notification_desc_big, "Hey " + patientName + " "+ description);
        notificationBig.setTextViewText(R.id.tv_notification_date_big, date);
        notificationBig.setTextViewText(R.id.tv_notification_time_big, time);
